...
export class GameModeService {
  ...
  public findAll(pageable: Pageable): Observable<Page<GameModeMinDTO>> {
    ...
    return this.httpClient.get<Page<GameModeMinDTO>>(`${this.API_URL}/gamemodes${queryParams}`);
  }

  public findById(id: number): Observable<GameModeDTO> {
    return this.httpClient.get<GameModeDTO>(`${this.API_URL}/gamemodes/${id}`);
  }
  ...
  public getPlayersRanking(
    ...
    positionId: number,
    pageable: Pageable,
  ): Observable<Page<PlayerFullDataDTO>> {
    let queryParams = '';
    ...
    return this.httpClient.get<Page<PlayerFullDataDTO>>(`${this.API_URL}/gamemodes/ranking${queryParams}`);
  }

  public save(gameModeRequest: GameModeRequestDTO): Observable<GameModeDTO> {
    return this.httpClient.post<GameModeDTO>(`${this.API_URL}/gamemodes`, gameModeRequest);
  }

  public updateById(id: number, gameModeRequest: GameModeRequestDTO): Observable<GameModeDTO> {
    return this.httpClient.put<GameModeDTO>(`${this.API_URL}/gamemodes/${id}`, gameModeRequest);
  }

  public deleteById(id: number): Observable<void> {
    return this.httpClient.delete<void>(`${this.API_URL}/gamemodes/${id}`);
  }
}
