...
export class PlayerService {
  ...
  public findAll(pageable: Pageable): Observable<Page<PlayerMinDTO>> {
    ...
    return this.httpClient.get<Page<PlayerMinDTO>>(`${this.API_URL}/players${queryParams}`);
  }

  public findById(id: number): Observable<PlayerFullDTO> {
    return this.httpClient.get<PlayerFullDTO>(`${this.API_URL}/players/${id}`);
  }
  ...
  public save(playerRequest: PostPlayerDTO): Observable<PlayerFullDTO> {
    ...
    return this.httpClient.post<PlayerFullDTO>(`${this.API_URL}/players`, body);
  }

  public update(playerRequest: UpdatePlayerDTO): Observable<PlayerFullDTO> {
    const body = this.convertPlayerRequestToFormData(playerRequest);
    return this.httpClient.put<PlayerFullDTO>(`${this.API_URL}/players/${playerRequest.id}`, body);
  }
  ...
  public deleteById(id: number): Observable<void> {
    return this.httpClient.delete<void>(`${this.API_URL}/players/${id}`);
  }
}
