...
export class PositionService {
  ...
  public findAll(pageable: Pageable): Observable<Page<PositionMinDTO>> {
    ...
    return this.httpClient.get<Page<PositionMinDTO>>(`${this.API_URL}/positions${queryParams}`);
  }

  public findById(id: number): Observable<PositionDTO> {
    return this.httpClient.get<PositionDTO>(`${this.API_URL}/positions/${id}`);
  }

  public save(positionRequest: PositionRequestDTO): Observable<PositionMinDTO> {
    return this.httpClient.post<PositionMinDTO>(`${this.API_URL}/positions`, positionRequest);
  }

  public updateById(id: number, positionRequest: PositionRequestDTO): Observable<PositionMinDTO> {
    return this.httpClient.put<PositionMinDTO>(`${this.API_URL}/positions/${id}`, positionRequest);
  }

  public deleteById(id: number): Observable<void> {
    return this.httpClient.delete<void>(`${this.API_URL}/positions/${id}`);
  }
}
