      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(SaveGamemodeFormComponent, {
                position: 'top',
          ...
          },
          {
            ...
            command: () => {
              ...
              this.dynamicDialogRef = this.customDialogService.open(EditGamemodeFormComponent, {
                position: 'top',
          ...
          },
          {
            ...
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(DeleteGamemodeFormComponent, {
                position: 'top',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: 'pi pi-fw pi-trash',
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(DeletePositionFormComponent, {
                position: 'top',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: 'pi pi-fw pi-plus',
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(SaveParameterFormComponent, {
                position: 'top',
          ...
          },
          {
            ...
            icon: 'pi pi-fw pi-pencil',
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(EditParameterFormComponent, {
                position: 'top',
          ...
          },
          {
            ...
            icon: 'pi pi-fw pi-trash',
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(DeleteParameterFormComponent, {
                position: 'top',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: 'pi pi-fw pi-plus',
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(SavePlayerFormComponent, {
                position: 'top',
          ...
          },
          {
            ...
            icon: 'pi pi-fw pi-trash',
            command: () => {
              this.dynamicDialogRef = this.customDialogService.open(DeletePlayerFormComponent, {
                position: 'top',
